...
DESCRIPTION = "Linux kernel for HP Touchpad Go"

# Mark archs/machines that this kernel supports
COMPATIBLE_MACHINE = "shortloin"
...
KMETA = "kernel-meta"
KBUILD_DEFCONFIG:shortloin = "shortloin_debug_defconfig"
...
do_deploy:append() {
    ...
    uboot-mkimage  -A arm -O Linux -T multi -n 'HP Touchpad Go boot' -C none \
