...
SRC_URI:append:tenderloin = "\
    ...
    file://ath6k/AR6003/hw2.1.1/athtcmd_ram.bin \
...
do_install:append:tenderloin() {
    ...
    install -m 0644 ${WORKDIR}/ath6k/AR6003/hw2.1.1/athtcmd_ram.bin ${D}/lib/firmware/ath6k/AR6003/hw2.1.1/athtcmd_ram.bin
    ...
    install -m 0644 ${WORKDIR}/regulatory.db ${D}/lib/firmware/regulatory.db
    install -m 0644 ${WORKDIR}/regulatory.db.p7s ${D}/lib/firmware/regulatory.db.p7s
}
